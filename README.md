...
A MSc Data Analytics student building end-to-end systems from ingestion and warehouse design through to the BI layer that people actually read.
...
search used to solve for the minimum savings rate that meets a fixed deadline.
